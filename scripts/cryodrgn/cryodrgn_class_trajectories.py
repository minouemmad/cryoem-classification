...
Run with the cryoDRGN env from repo root::
    ...
    python scripts/cryodrgn/cryodrgn_class_trajectories.py \
      --dataset "J1442:results_cryodrgn/J1442_gP25_WT_POSE_BIAS/train_z10/z.100.pkl:data/cryosparc_P25_J1442_passthrough_particles_all_classes.cs:data/cryosparc_P25_J1442_00000_particles.cs:6,7,8:data/J1442_classes" \
