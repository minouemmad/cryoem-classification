...
N_DUMMIES = min(6, max(0, num_classes - 2))
N_KEEP = num_classes - N_DUMMIES
probabilities_nondummies = probabilities_df[probabilities_df['Original Assignment'] > N_DUMMIES]
...
plt.plot(range(1, N_KEEP + 1), np.cumsum(pca.explained_variance_ratio_), marker='o', linestyle='--')
